...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "jamilwilliams054@gmail",
    href: "mailto:jamilwilliams054@gmail.com",
    ...
    <div className="container mx-auto px-4 md:px-[50px] xl:px-[200px] text-zinc-300 pt-20 pb-20">
      <div className="flex flex-col lg:flex-row gap-5">
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Jamil Williams</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            <h1 className="text-3xl mb-10 lg:md-20">Sobre mí</h1>
            <p className="mb-10 text-roboto">
              ¡Hola! Soy Jamil Williams, estudiante de desarrollo de software apasionado por
              crear experiencias digitales significativas. Con gran interés en el desarrollo web,
              me esfuerzo por convertir ideas en realidad a través de la programación
              y el diseño. Mi viaje comenzó con una fascinación por la tecnología y
              un impulso por hacer un impacto positivo.
            </p>
            <p className="mb-10">
              Cuando no estoy programando, puedes encontrarme explorando nuevas tecnologías,
              o tomando café mientras pienso en mi próximo proyecto.
            </p>
